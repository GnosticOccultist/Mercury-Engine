...
/**
 * <code>MouseEvent</code> is an implementation of {@link InputEvent} for
 * handling mouse related events which occurred when the mouse is on-screen. It
 * contains data about the mouse cursor position.
 * 
...
public class MouseEvent extends InputEvent implements Input {
    ...
    /**
     * The event type returned whenever a mouse is dragged meaning mouse is moving
    ...
    /**
     * The event type returned whenever a mouse button is being clicked (pressed and
     * released in a small time interval).
     */
    ...
    /**
     * Instantiates a new <code>MouseEvent</code> with the given {@link EventType}
     * and other informations such as position, button interaction.
     * <p>
     * Note that the interaction depends on the event type, for example it will be
     * pressed if the event type is {@link #MOUSE_PRESSED}.
     * 
     ...
     * @param dx     The change amount of the mouse X-coordinate in screen
     *               coordinates.
     * @param dy     The change amount of the mouse Y-coordinate in screen
     *               coordinates.
    ...
    /**
     * Return the button being interacted in the <code>MouseEvent</code> or
     * {@link GLFWMouseInput#BUTTON_UNDEFINED} if none button is currently being
     * interacted.
     * 
    ...
    /**
     * Return the change amount on the X-axis based on the last
     * <code>MouseEvent</code> in screen coordinates, relative to the upper-left
    ...
    /**
     * Return the change amount on the Y-axis based on the last
     * <code>MouseEvent</code> in screen coordinates, relative to the upper-left
     * corner of the window.
     * 
    ...
    /**
     * Return the change amount of the wheel movement based on the last
     * <code>MouseEvent</code>.
     * 
    ...
    public String toString() {
        ...
        return getClass().getSimpleName() + "[ type= " + type + ", button= " + button + modStr + ", x= " + x + ", y= "
                + y + ", dWheel= " + dWheel + " ]";
    }
}
