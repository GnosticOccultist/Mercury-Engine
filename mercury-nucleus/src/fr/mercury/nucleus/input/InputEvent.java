...
public abstract class InputEvent {
	...
	/**
	 * Return whether the <code>InputEvent</code> has been consumed meaning it's no longer
	 * valid and shouldn't be propagated anymore.
	 * 
	...
	/**
	 * Consume the <code>InputEvent</code> meaning it's no longer valid and shouldn't
	 * be propagated anymore.
	 */
	public void consume() {
		this.consumed = true;
	}
