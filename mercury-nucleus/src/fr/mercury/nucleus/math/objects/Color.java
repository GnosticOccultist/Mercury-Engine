...
public final class Color implements ReadableColor, Comparable<Color>, Reusable {
    ...
    /**
     * Instantiates a new <code>Color</code> with all the components set to 1. It is
     * the equivalent to the white color.
     */
    public Color() {
        this.r = g = b = a = 1.0f;
    }
    ...
    /**
     * Instantiates a new <code>Color</code> with the provided components.
     * 
    ...
    /**
     * Instantiates a new <code>Color</code> with the provided components. The alpha
    ...
    /**
     * Instantiates a new <code>Color</code> with the provided color's components.
     * 
    ...
    /**
     * Set the provided components values to this <code>Color</code> components.
     * 
     * @param r The red component to copy from.
     * @param g The green component to copy from.
     * @param b The blue component to copy from.
    ...
    /**
     * Set the components values of the provided color to this <code>Color</code>
     * components.
     * <p>
     ...
     * green and blue components, the alpha one isn't incorporated.
     *
    ...
    /**
     * Transform this <code>Color</code> to a <code>Vector4f</code> using the red,
    ...
    /**
     * Return the red component of the <code>Color</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Return the green component of the <code>Color</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Return the blue component of the <code>Color</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Return the alpha component of the <code>Color</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Sets all the components of the <code>Color</code> to {@link #WHITE}, before
     * retrieving it from a pool.
     */
    @Override
    public void reuse() {
        set(1, 1, 1, 1);
