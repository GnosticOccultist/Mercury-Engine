...
/**
 * <code>Quaternion</code> defines a rotation in 4 dimensions instead of 3, using hypercomplex numbers. It avoids "gimbal lock" 
 * by allowing a smooth rotation without any movement blocking. Simpler to compose than the <code>Euler angles</code> and 
 * more compact and efficient than the rotation
 * matrices.
 * <p>
 * Example of representation: <i>
 * <li>A rotation in 3-axis. </i></li>
 * <p>
 * 
...
public final class Quaternion implements ReadableQuaternion, Comparable<Quaternion>, Reusable {
    ...
    /**
     * Instantiates a new <code>Quaternion</code> with identity values {0,0,0,1}.
     */
    public Quaternion() {
        set(0, 0, 0, 1);
    }
    ...
    /**
     * Instantiates a new <code>Quaternion</code> with the provided components.
     * 
    ...
    /**
     * Instantiates a new <code>Quaternion</code> with the provided quaternion's
     * components.
     * 
    ...
    /**
     * Set the components values of the provided quaternion to this <code>Quaternion</code> 
     * components.
     * 
     * @param other The other quaternion to copy from (not null).
     */
     ...
     * 
     * @param other The other quaternion to addition (not null).
     * @return      The quaternion with its new components values.
     */
     ...
     * 
     * @param other The other quaternion to subtract (not null).
     * @return      The quaternion with its new components values.
     */
     ...
     * 
     * @param other The other quaternion to multiply (not null).
     * @return      The quaternion with its new components values.
     */
    ...
    /**
     * Multiplies the <code>Quaternion</code> by the provided one and store the
     * result in the given quaternion store or a new instance one if null.
     * 
     * @param quat  The quaternion to multiply by (not null).
     * @param store The quaternion to store the result.
     * @return      The result in the store or a new quaternion instance.
     */
    public Quaternion mul(Quaternion quat, Quaternion store) {
        Validator.nonNull(quat, "The quaternion can't be null!");
    ...
    /**
     * Multiplies the <code>Quaternion</code> with the provided {@link Vector3f}.
     * The result is stored in the given vector.
     * 
     * @param vector The vector to multiply the quaternion by (not null).
    ...
    public Vector3f mul(Vector3f vector) {
        ...
        float tempX, tempY;
        tempX = w * w * vector.x + 2 * y * w * vector.z - 2 * z * w * vector.y + x * x * vector.x + 2 * y * x * vector.y
                + 2 * z * x * vector.z - z * z * vector.x - y * y * vector.x;
        tempY = 2 * x * y * vector.x + y * y * vector.y + 2 * z * y * vector.z + 2 * w * z * vector.x - z * z * vector.y
                + w * w * vector.y - 2 * x * w * vector.z - x * x * vector.y;
    ...
    /**
     * Normalizes the <code>Quaternion</code>. It will will divide the quaternion's
     * components by its {@link #norm()}.
     * 
     ...
     * <code>Quaternion</code>. The index must be between 0 and 2 included:
    ...
    /**
     * Sets the <code>Quaternion</code> components to match the provided rotation
     * angles.
     * 
    ...
    /**
     * Converts the <code>Quaternion</code> to a rotation {@link Matrix4f}, stored
    ...
    /**
     * Converts the <code>Quaternion</code> to a rotation {@link Matrix3f}, stored
     * into the provided matrix.
     * 
     * @param result The matrix to store the result.
     * @return       A rotation matrix either the store or a new matrix instance.
    ...
    /**
     * Return the X-component of the <code>Quaternion</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Return the Y-component of the <code>Quaternion</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Return the Z-component of the <code>Quaternion</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Return the W-component of the <code>Quaternion</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Sets all the components of the <code>Quaternion</code> to the
    ...
    /**
     * Compare this quaternion with the provided <code>Quaternion</code>. It will
     * first compare the X-component, then the Y-component, the Z-component and so
     * on.
     * 
     * @param other The other quaternion to compare with (not null).
     * @return      0 &rarr; the 2 quaternions are equal, negative &rarr; this quaternion
     *              comes before the other, negative &rarr; this quaternion comes after
     *              the other.
     */
    @Override
    ...
    /**
     * Return a unique code for the <code>Quaternion</code> based on each component
     * value. If two quaternions are logically equivalent, they will return the same
     * hash code value.
     * 
