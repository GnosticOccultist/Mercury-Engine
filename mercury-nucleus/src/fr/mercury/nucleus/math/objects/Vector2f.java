...
/**
 * <code>Vector2f</code> is a mathematical utility class representing a vector with 2 components 
 * on the 2 axis (X;Y) of a 2D space. It contains some utility methods for fast calculation 
 * or physical determination.
 * <p>
 * Example of representation: <i>
 * <li>A texture coordinate
 * <li>A plane </i></li>
 * <p>
 * 
...
public final class Vector2f implements ReadableVector2f, Comparable<Vector2f>, Reusable {
    ...
    /**
     * Instantiates a new <code>Vector2f</code> with 0 value for each component
     * {0,0}.
     */
    public Vector2f() {
        set(0, 0);
    ...
    /**
     * Instantiates a new <code>Vector2f</code> with the provided components.
     * 
    ...
    /**
     * Instantiates a new <code>Vector2f</code> with the provided vector's
     * components.
     * 
    ...
    /**
     * Set the provided components values to this <code>Vector2f</code> components.
     * 
    ...
    /**
     * Set the components values of the provided vector to this <code>Vector2f</code> 
     * components.
     * 
    ...
    /**
     * Normalizes the <code>Vector2f</code>. It will will divide the vector's
    ...
    /**
     * Return the X-component of the <code>Vector2f</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Return the Y-component of the <code>Vector2f</code>, as a single-precision
     * float.
     * 
    ...
    /**
     * Sets all the components of the <code>Vector2f</code> to 0, before retrieving
     * it from a pool.
     */
    @Override
    public void reuse() {
    ...
    /**
     * Sets all the components of the <code>Vector2f</code> to 0, before storing it
     * into a pool.
     */
    @Override
    public void free() {
    ...
    /**
     * Return a unique code for the <code>Vector2f</code> based on each component
    ...
    /**
     * Return whether the provided object is equal to the <code>Vector2f</code>. It
     * checks that all 2 component values are the same.
     * 
    ...
    /**
     * Return the string representation of the <code>Vector2f</code> with the
     * format: <code>Vector2f[ x, y ]</code>.
     * 
