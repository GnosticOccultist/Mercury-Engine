...
public interface ReadableVector4f {
    ...
    /**
     * Return the X-component of the <code>ReadableVector4f</code>, as a
    ...
    /**
     * Return the Y-component of the <code>ReadableVector4f</code>, as a
     * single-precision float.
     * 
    ...
    /**
     * Return the Z-component of the <code>ReadableVector4f</code>, as a
     * single-precision float.
     * 
    ...
    /**
     * Return the W-component of the <code>ReadableVector4f</code>, as a
     * single-precision float.
     * 
    ...
    /**
     * Return whether the <code>ReadableVector4f</code> is a unit vector, meaning
    ...
    /**
     * Calculates the dot product of the <code>ReadableVector4f</code> with the
    ...
    /**
     * Calculates the distance between the <code>ReadableVector4f</code> and the
     * provided one.
     *
     ...
     * <code>ReadableVector4f</code> are equal, meaning this vector is uniformized.
     * 
    ...
    /**
     * Return whether all 4 single-precision components of the
     * <code>ReadableVector4f</code> are equal to zero, meaning this vector is a
     * zero-vector.
     * 
    ...
    /**
     * Return whether all 4 single-precision components of the
     * <code>ReadableVector4f</code> are equal to one, meaning this vector is an
     * identity-vector.
     * 
