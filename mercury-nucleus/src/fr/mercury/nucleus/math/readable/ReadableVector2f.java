...
public interface ReadableVector2f {
    ...
    /**
     * Return the X-component of the <code>ReadableVector2f</code>, as a
    ...
    /**
     * Return the Y-component of the <code>ReadableVector2f</code>, as a
     * single-precision float.
     * 
    ...
    /**
     * Return whether the <code>ReadableVector2f</code> is a unit vector, meaning
    ...
    /**
     * Calculates the dot product of the <code>ReadableVector2f</code> with the
    ...
    /**
     * Calculates the distance between the <code>ReadableVector2f</code> and the
     * provided one.
     *
    ...
    /**
     * Return whether both single-precision components of the
     * <code>ReadableVector2f</code> are equal, meaning this vector is uniformized.
     * 
    ...
    /**
     * Return whether both single-precision components of the
     * <code>ReadableVector2f</code> are equal to zero, meaning this vector is a
     * zero-vector.
     * 
    ...
    /**
     * Return whether both single-precision components of the
     * <code>ReadableVector2f</code> are equal to one, meaning this vector is an
     * identity-vector.
     * 
