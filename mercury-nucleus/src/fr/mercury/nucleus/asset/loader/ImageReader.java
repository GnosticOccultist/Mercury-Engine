...
/**
 * <code>ImageReader</code> is an implementation of {@link AssetLoader} designed to load a texture file, 
 * present on the disk, into an {@link Image} which is turned into a {@link Texture} to be used with the rendering context.
 * 
...
public class ImageReader implements AssetLoader<Image> {
     ...
     */
    public static final AssetLoaderDescriptor<ImageReader> DESCRIPTOR = new AssetLoaderDescriptor<>(
            ImageReader::new,
