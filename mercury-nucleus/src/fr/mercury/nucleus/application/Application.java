...
/**
 * <code>Application</code> is an interface to easily implement a usable application, by creating 
 * the essentials functions.
 * 
...
public interface Application {
    ...
    /**
     * Restart the <code>Application</code>, applying the new {@link MercurySettings} to 
     * the {@link MercuryContext} and restarting it.
     */
    void restart();
