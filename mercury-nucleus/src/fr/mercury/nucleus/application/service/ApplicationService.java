...
public interface ApplicationService {
	...
	/**
	 * Update the <code>ApplicationService</code> using the specified {@link ReadableTimer}. The
	...
	/**
	 * Cleanup the <code>ApplicationService</code> when no longer used or when the {@link Application} 
	 * is closing.
	 */
	void cleanup();
