...
public enum VertexBufferType {
    ...
    /**
     * Defines the normal vector for the vertex with 3 floats component. It is
     * expected to be normalized as it express a direction.
     */
    NORMAL(BufferType.VERTEX_DATA, 3, Format.FLOAT),
    /**
     * Defines the tangent vector for the vertex with 3 floats component. It is
     * expected to be normalized as it express a direction.
     */
     ...
     * <p>
     * <b> IMPORTANT: This is optional since it can be easily computed with the
     * normal and tangent vectors.</b>
     */
    BITANGENT(BufferType.VERTEX_DATA, 3, Format.FLOAT),
    /**
     * Defines the weight for the joint with 4 floats component. This is used for an
     * animated mesh.
     */
    WEIGHT(BufferType.VERTEX_DATA, 4, Format.FLOAT),
    /**
     * Defines the index for the joint with 4 floats component. This is used for an
     * animated mesh.
     */
    ...
    /**
     * A custom vertex buffer which uses interleaved data format, if such vertex
     * buffer is defined in a Mesh, then it will be used to pass data to vertex
     * attributes.
     */
    ...
    /**
     * Return the buffer type of the vertex buffer. Either
     * {@link BufferType#VERTEX_DATA} or {@link BufferType#VERTEX_INDEXING}
     * 
    ...
    /**
     * Return the equivalent OpenGL buffer type. Either {@link GL15#GL_ARRAY_BUFFER}
     * or {@link GL15#GL_ELEMENT_ARRAY_BUFFER}.
     * 
    ...
    /**
     * Return the format for each values of the <code>VertexBufferType</code>. It's
     * only the recommended format that is used by default if not declared in the
    ...
    /**
     * Return the OpenGL equivalent format to this <code>VertexBufferType</code>'s
     * {@link Format}.
     * 
    ...
    /**
     * <code>Format</code> is an enumeration which describes the various format
     * handled by <code>Mercury-Engine</code> and the graphics API OpenGL.
     * 
     * @author Stickxy
     */
    public enum Format {
        ...
        /**
         * Returns whether the <code>Format</code> is a floating-point type. If this is
         * <code>true</code> the value can't be normalized.
         * 
