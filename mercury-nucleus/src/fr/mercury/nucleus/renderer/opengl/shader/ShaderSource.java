...
public final class ShaderSource extends GLObject {
    ...
    /**
     * Whether the source has been changed and needs to be re-uploaded to program.
     */
    private boolean needsUpdate = true;

    /**
     * Instantiates a new <code>ShaderSource</code> with the provided
     * {@link ShaderType type} and the source code. The provided source must not be
     * empty or null.
     * <p>
    ...
    /**
     * Generates the entire shader code of the <code>ShaderSource</code>, based on
     * the provided source and defines.
     * 
     ...
     * 
     * @param source The source code to be used by the shader (not null or empty).
     */
    ...
    /**
     * Return whether the <code>ShaderSource</code> needs to be recompiled, to take
