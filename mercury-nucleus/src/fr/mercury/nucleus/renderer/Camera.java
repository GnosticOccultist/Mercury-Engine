...
public final class Camera {
    ...
    /**
     * The accumulated dirty fields by the camera. At instantiation it will contain
     * {@link CameraDirtyFields#DEPTH_RANGE},
     * {@link CameraDirtyFields#PROJECTION_MATRIX},
     * {@link CameraDirtyFields#VIEW_MATRIX}.
     */
    ...
    /**
     * Instantiates a new perspective <code>Camera</code> object with the specified
     * width and height.
     * 
    ...
    /**
     * Instantiates a new <code>Camera</code> object with the specified width and
     * height as well as the {@link GraphicalProjectionMode}.
     * 
     * @param projectionMode The graphical projection mode the camera uses to render
     *                       the scene on the screen (not null).
     * @param width          The width of the camera viewport.
     * @param height         The height of the camera viewport.
     */
    ...
    /**
     * Resize the <code>Camera</code> with the provided new width and height values
     * if they have been modified. It will recompute the projection matrix using the
     * new width and height during the next call of
     * {@link #prepare(AbstractRenderer)} which should occur before every rendering
     * cycle.
     * 
    ...
    /**
     * Sets the frustum planes values of the <code>Camera</code> using the given
     * perspective values. The method will mark the camera as dirty, and the new
    ...
    /**
     * Update the projection {@link Matrix4f} of the <code>Camera</code> according
     * to its {@link GraphicalProjectionMode}.
     */
    protected void updateProjectionMatrix() {
        switch (projectionMode) {
        case ORTHOGRAPHIC:
            projectionMatrix.orthographic(frustumNear, frustumFar, frustumLeft, frustumRight, frustumTop,
                    frustumBottom);
            break;
        case PERSPECTIVE:
    ...
    /**
     * Orientates the <code>Camera</code> towards the provided world position vector
     * using the difference between it and the camera location as the new facing
     * direction and the world up vector to compute the left and up-axis of the
     * camera.
     * 
     ...
     * @param worldUpVector A normalized vector describing the up direction of the
     *                      world (default&rarr;[0, 1, 0]).
     */
    ...
    /**
     * Orientates the <code>Camera</code> towards the provided world position using
     * the difference between it and the camera location as the new facing direction
     * and the world up vector to compute the left and up-axis of the camera.
     * 
     * @param x             The X world coordinate to look at.
     * @param y             The Y world coordinate to look at.
     * @param z             The Z world coordinate to look at.
    ...
    /**
     * Prepares the <code>Camera</code> before performing the rendering using the
     * provided {@link AbstractRenderer}. This method will update fields or
     * recompute useful matrices.
     * 
    ...
    /**
     * Return the width of the <code>Camera</code>, usually the width of the
     * display.
     * 
    ...
    /**
     * Return the height of the <code>Camera</code>, usually the height of the
     * display.
     * 
     ...
     * The method will set automatically the camera into
     * {@link GraphicalProjectionMode#PERSPECTIVE} and compute the new projection
     * matrix.
     * 
    ...
    /**
     * Return the zooming factor of the <code>Camera</code>. The value is only used
     * when the camera is in {@link GraphicalProjectionMode#ORTHOGRAPHIC}.
     * 
    ...
    /**
     * Sets the zooming factor of the <code>Camera</code>. The method will set
     * automatically the camera into {@link GraphicalProjectionMode#ORTHOGRAPHIC}
    ...
    /**
     * Sets the left-axis vector of the <code>Camera</code> to the provided one. The
     * method will mark the camera as dirty, and the new view matrix will be
    ...
    /**
     * Sets the up-axis vector of the <code>Camera</code> to the provided one. The
     * method will mark the camera as dirty, and the new view matrix will be
     * computed and applied on the next call of {@link #prepare(AbstractRenderer)}.
     * 
    ...
    /**
     * Sets the direction vector that the <code>Camera</code> is facing to the
     * provided one. The method will mark the camera as dirty, and the new view
     * matrix will be computed and applied on the next call of
     * {@link #prepare(AbstractRenderer)}.
     * 
     ...
     * 
     * @param mode The projection mode used by the camera (not null, default &rarr;
     *             perspective).
     */
    ...
    /**
     * Adds the specified {@link RenderLayer} to be managed by the
     * <code>Camera</code>.
     * 
    ...
    /**
     * Removes the specified {@link RenderLayer} to no longer be managed by the
     * <code>Camera</code>.
     * 
    ...
    /**
     * Checks whether the specified {@link RenderLayer} is used by the
     * <code>Camera</code>, meaning it will queue and render all {@link AnimaMundi}
    ...
    /**
     * <code>GraphicalProjectionMode</code> enumerates all possible projection modes
     * available for a <code>Camera</code>.
     * 
     * @author GnosticOccultist
     */
    public enum GraphicalProjectionMode {
        /**
         * A linear projection mode used to render three-dimensional geometries on a
         * picture plane.
         * <p>
         * Distant object appears smaller than nearer ones and parallel line seems to
         * converge into a single point named 'vanishing point'.
         */
        PERSPECTIVE,
        /**
         * A projection mode used to render two-dimensional representation of 3D
         * geometries.
         * <p>
         * It is using an orthogonal line for each point of the geometry which is
         * directly projected onto the projection plane.
         */
        ORTHOGRAPHIC;
    }
