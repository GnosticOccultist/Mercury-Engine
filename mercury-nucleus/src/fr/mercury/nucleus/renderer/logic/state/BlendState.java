...
/**
 * <code>BlendState</code> is an implementation of {@link RenderState} to provide information of how a source pixel is blended to 
...
public final class BlendState extends RenderState {
    ...
    /**
     * Instantiates a new disabled <code>BlendState</code> with the source factor
     * being {@link BlendFunction#ONE} and the destination factor being
     * {@link BlendFunction#ZERO}.
     * 
     * @see #reset()
     */
    public BlendState() {
    ...
    /**
     * Enable the <code>BlendState</code>. When applied as a render state for an
     * {@link AnimaMundi}, it will enable blending between new and back fragment
     * using the set {@link BlendFunction}.
     * 
    ...
    /**
     * Disable the <code>BlendState</code>. When applied as a render state for an
     * {@link AnimaMundi}, it will disable the blending between new and back
     * fragment and will just override the previously set pixel.
     * <p>
    ...
    /**
     * Return the {@link BlendFunction} to use for the source weighting factor of
     * the blending.
     * 
    ...
    /**
     * Return the {@link BlendFunction} to use for the destination weighting factor
     * of the blending.
     * 
    ...
    /**
     * Sets the {@link BlendFunction} to use for the source weighting factor of the
     * blending.
     * 
    ...
    /**
     * Sets the {@link BlendFunction} to use for the destination weighting factor of 
     * the blending.
     * 
    ...
    /**
     * Resets the <code>BlendState</code> to its default state, meaning its disabled
     * with the source factor set to {@link BlendFunction#ONE} and the destination
     * factor set to {@link BlendFunction#ZERO}.
     */
    @Override
    public void reset() {
        this.enabled = false;
    ...
    /**
     * <code>BlendFunction</code> is an enumeration of all possible weighting
     * factors to use in the blending function used by the rasterizer.
     * 
     * @author GnosticOccultist
     */
