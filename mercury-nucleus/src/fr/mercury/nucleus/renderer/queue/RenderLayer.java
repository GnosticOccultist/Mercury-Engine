...
public final class RenderLayer implements Comparable<RenderLayer> {
	...
	/**
	 * Use the {@link AnimaMundi}'s parent render layer, or default to {@link #DEFAULT} if it is orphan.
	 */
	 ...
	 * <p>
	 * If the render layer doesn't already exists it will instantiates a new one with this
