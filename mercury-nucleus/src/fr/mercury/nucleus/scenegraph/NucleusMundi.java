 ...
 */
public class NucleusMundi extends AnimaMundi implements Iterable<AnimaMundi> {
    ...
    /**
     * Instantiates a new <code>NucleusMundi</code> with the {@link Transform} set
     * to identity values.
     */
    public NucleusMundi() {
        super();
    ...
    /**
     * Attach all the provided <code>AnimaMundi</code> to the
    ...
    /**
     * Detach all the provided <code>AnimaMundi</code> from the
     * <code>NucleusMundi</code>.
     * 
    ...
    /**
     * Return a readable-only array containing the children of the
     * <code>NucleusMundi</code>. To actually modify the array, use
     * {@link #attach(AnimaMundi)} or {@link #detach(AnimaMundi)} methods instead.
     * 
    ...
    /**
     * Return whether the <code>NucleusMundi</code> is an external one, meaning it
     * has no children.
     * 
    ...
    @Override
    public Iterator<AnimaMundi> iterator() {
        return children.iterator();
    }

    /**
     * Visit the <code>NucleusMundi</code> with the specified {@link Visitor} and
     * {@link VisitType}. 
     * <br>
     * If the type corresponds to {@link VisitType#PRE_ORDER}, it will first visit
     * the node and then its children otherwise, if the type equals to
     * {@link VisitType#POST_ORDER}, it will first visit each children and then the
     * node itself.
     */
    @Override
