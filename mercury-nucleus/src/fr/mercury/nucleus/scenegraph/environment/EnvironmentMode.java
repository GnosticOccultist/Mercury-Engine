...
public enum EnvironmentMode {
    /**
     * Always search on the local-defined environment and return null if nothing was
     * found.
     */
    LOCAL_ONLY,
    /**
    ...
    ANCESTOR_PRIORITY,
    /**
     * Always search on the local's environment and then search on the ancestor's one if 
     * the caller doesn't have the specific environment registered.
     */
    LOCAL_PRIORITY;
}
