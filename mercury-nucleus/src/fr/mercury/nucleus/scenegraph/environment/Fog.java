...
public final class Fog implements EnvironmentElement {
    ...
    /**
     * Instantiates a new <code>Fog</code> with a {@link Color#WHITE}. The density
     * is set to 0, meaning the fog effect won't be visible on the scene.
     */
    public Fog() {
        this(new Color(), 0f);
    }
    ...
    /**
     * Instantiates a new <code>Fog</code> with the provided color and density.
     * 
