...
public class PhysicaMundi extends AnimaMundi {
    ...
    /**
     * Instantiates a new <code>PhysicaMundi</code> with no {@link Mesh} so no
    ...
    /**
     * Instantiates a new <code>PhysicaMundi</code> by setting its {@link Mesh} to
     * the provided one.
     * 
    ...
    /**
     * Instantiates a new <code>PhysicaMundi</code> with the given name and by
     * setting its {@link Mesh} to the provided one.
     * 
